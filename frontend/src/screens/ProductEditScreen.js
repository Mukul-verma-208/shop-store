...
const ProductEditScreen = () => {
    ...
    let productDetails, productUpdate
    productDetails = useSelector((state) => state.productDetails)
    const { loading, error, product } = productDetails

    productUpdate = useSelector((state) => state.productUpdate)
    ...
    }, [dispatch, history, productId, product, successUpdate, id])
    ...
    const submitHandler = (e) => {
        ...
        if (productId) {
            ...
            history('/admin/productlist?noEdit=1')
        }
    }
                ...
                {loading ? <Loader /> : error ? <Message variant='danger'>{error}</Message> : (
                    <Form onSubmit={submitHandler}>
                        ...
                        <Form.Group controlId='image'>
                            ...
                            {/*<Form.Label>Upload Image below</Form.Label>
